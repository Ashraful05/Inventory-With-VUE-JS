    ...
    <div id="wrapper">
        ...
        <nav id="sidebar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget-password' ? false : true " style="display:none;">
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <router-link to="/stock" class="nav-link" aria-expanded="false" aria-controls="">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseBootstrap7" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <router-link to="report-one" class="collapse-item" >Report One</router-link>
                            <router-link to="report-two" class="collapse-item" >Report Two</router-link>
                        </div>
                    </div>
                </li>
                <hr class="sidebar-divider">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <!-- TopBar -->
                <nav id="topbar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget-password' ? false : true " style="display:none;" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
