<template>
    <div>
        <div>
            <router-link to="order" class="btn btn-outline-primary">Today Order</router-link>
        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <form class="user" @submit.prevent="searchDate()">
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="date" v-model="date" class="form-control" id="exampleInputFirstName" required>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block">Search Order</button>
                                        </div>
                                        <hr>
